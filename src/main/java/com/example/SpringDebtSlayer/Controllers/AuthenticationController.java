...
import com.example.SpringDebtSlayer.Models.forms.LoginForm;
import com.example.SpringDebtSlayer.Models.forms.RegisterForm;
...
// Handlers for home page/startup, registration, login, and logout.
@Controller
public class AuthenticationController extends AbstractController {
    ...
    } // Add HttpServletRequest request? Add User user?

    @RequestMapping(value = "/register") // TODO: Log out existing sessioner?
    ...
    public String login(Model model) {
        ...
        model.addAttribute("title", "Log In to DebtSlayer");
        return "login";
    }
